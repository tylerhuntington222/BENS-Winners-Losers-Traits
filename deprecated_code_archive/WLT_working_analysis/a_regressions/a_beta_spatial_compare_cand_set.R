...
counts = c(b200_count_a, b400_count_a, b800_count_a, b1000_count_a, b3000_count_a)
...
print(data.frame(b200_count_a, b400_count_a, b800_count_a, b1000_count_a, b3000_count_a))
